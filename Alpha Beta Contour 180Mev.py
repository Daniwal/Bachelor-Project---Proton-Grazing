...
file_path = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_0deg_1cm.csv'
data = pd.read_csv(file_path, comment='#', header=None, names=['x', 'y', 'z', 'dose'])



file_path2 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_5deg.csv'
data2 = pd.read_csv(file_path2, comment='#', header=None, names=['x', 'y', 'z', 'dose'])

file_path3 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_7.5deg.csv'
data3 = pd.read_csv(file_path3, comment='#', header=None, names=['x', 'y', 'z', 'dose'])

file_path4 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_10Deg_1cm.csv'
data4 = pd.read_csv(file_path4, comment='#', header=None, names=['x', 'y', 'z', 'dose'])




file_path35_1 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_1cm.csv'
data35_1 = pd.read_csv(file_path35_1, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_05 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.5cm.csv'
data35_05 = pd.read_csv(file_path35_05, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_01 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.1cm.csv'
data35_01 = pd.read_csv(file_path35_01, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.05cm.csv'
data35_005 = pd.read_csv(file_path35_005, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_001 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.01cm.csv'
data35_001 = pd.read_csv(file_path35_001, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_0005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.005cm.csv'
data35_0005 = pd.read_csv(file_path35_0005, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_0001 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.001cm.csv'
data35_0001 = pd.read_csv(file_path35_0001, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path35_00005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_3.5Deg_0.0005cm.csv'
...
plt.title('Angular Dist. Contour 0 deg, 180 MeV')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_0Deg.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Angular Dist. Contour 5 deg, 180 MeV \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_5Deg.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Angular Dist. Contour 7.5 deg, 180 MeV \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_7.5Deg.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Angular Dist. Contour 10 deg, 180 MeV \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 1cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg1.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.5 \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg2.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.1cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg3.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.05cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg4.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.01cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg5.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.005cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/ContourPlot_180_3.5Deg6.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.001cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg7.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 3.5 deg, 180 MeV, SL= 0.0005cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.tight_layout()
plt.grid()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_3.5Deg8.png", dpi=300)
...
file_path10_1 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_10Deg_1cm.csv'
data10_1 = pd.read_csv(file_path10_1, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_05 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.5cm.csv'
data10_05 = pd.read_csv(file_path10_05, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_01 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.1cm.csv'
data10_01 = pd.read_csv(file_path10_01, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.05cm.csv'
data10_005 = pd.read_csv(file_path10_005, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_001 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.01cm.csv'
data10_001 = pd.read_csv(file_path10_001, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_0005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.005cm.csv'
data10_0005 = pd.read_csv(file_path10_0005, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_0001 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_Deg10_0.001cm.csv'
data10_0001 = pd.read_csv(file_path10_0001, comment='#', header=None, names=['x', 'y', 'z', 'dose'])
#
file_path10_00005 = '/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Output files/GE_F1.14438563/180MeV_Dose2D_10Deg_0.0005cm.csv'
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 1cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg1.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.5 \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg2.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.1cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg3.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.05cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg4.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.01cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg5.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.005cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/ContourPlot_180_10Deg6.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.001cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.grid()
plt.tight_layout()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg7.png", dpi=300)
...
plt.axhline(y=0, color='grey', linestyle='--')
plt.axvline(x=0, color='grey', linestyle='--')
plt.title('Contour Plot: 10 deg, 180 MeV, SL= 0.0005cm \n')
plt.xlabel(r'$\alpha$ ($^\circ$)')
plt.ylabel(r'$\beta$ ($^\circ$)')
plt.tight_layout()
plt.grid()
plt.savefig("/Users/danielwaldstromhenriksen/Documents/Documents copy/Skole/Uni/6. Semester/Bachelor Projekt/Plots/ContourPlot_180_10Deg8.png", dpi=300)
